    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <small>estimation from 341kb of code in 234 edited files across 100 commits</small>
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    <mask id="languages-bar">
                        <rect x="0" y="0" width="460" height="8" fill="white" rx="5"/>
                    </mask>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="429.78609747226767" height="8" fill="#3178c6"/>
                    <rect mask="url(#languages-bar)" x="429.78609747226767" y="0" width="25.78559738134206" height="8" fill="#ededed"/>
                    <rect mask="url(#languages-bar)" x="455.57169485360976" y="0" width="4.198263320603746" height="8" fill="#ededed"/>
                    <rect mask="url(#languages-bar)" x="459.76995817421346" y="0" width="0.23004182578650664" height="8" fill="#ededed"/>
                </svg>
